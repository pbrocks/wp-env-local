...
<div class="wrap">
    ...
    <form action="options.php" method="post">
        <?php
            ...
            settings_fields( 'starter' ); // Unique name for the settings fields.
            // Output setting sections and their fields.
            do_settings_sections( 'starter' ); // Unique name for the settings sections.
...
function starter_settings_init() {
    ...
    add_settings_section(
        ...
        __( 'The Matrix has you when you decide to allow it.', 'starter-settings' ),
        'starter_section_developers_callback',
        'starter' // Unique name for the settings sections.
    );
    ...
    add_settings_field(
        ...
        'starter', // Unique name for the settings fields.
        'starter_section_developers',
        array(
    ...
    add_settings_field(
        ...
        __( 'Metanym (nomenclature)', 'starter-settings' ),
...
<?php
    if ( isset( $options['textarea_field_0'] ) ) {
        ...
        '<span style="font-weight: 800;">' . __( 'You have entered: %s', 'starter-settings' ) . '</span>',
...
<p id="<?php echo esc_attr( $args['id'] ); ?>">
    <?php esc_html_e( 'Follow the white rabbit.', 'starter-settings' ); ?>
</p>
<?php
}
...
<?php
    if ( isset($options['starter_field_pill']) ) {
